...
var Zepto = function() {
    function L(t) {
        return null == t ? String(t) : C[T.call(t)] || "object"
    }
    ...
    function M(t) {
        return F(t) && !D(t) && Object.getPrototypeOf(t) == Object.prototype
    }
    ...
    function U(n, i, r) {
        for (e in i) r && (M(i[e]) || k(i[e])) ? (M(i[e]) && !M(n[e]) && (n[e] = {}), k(i[e]) && !k(n[e]) && (n[e] = []), U(n[e], i[e], r)) : i[e] !== t && (n[e] = i[e])
    }
    ...
    return S.matches = function(t, e) {
        ...
        var i, r = t.parentNode,
            o = !r;
        return o && (r = P).appendChild(t), i = ~S.qsa(r, e).indexOf(t), o && P.removeChild(t), i
    }, N = function(t) {
        ...
        return p.test(e) && (o = n(u.createElement(RegExp.$1))), o || (e.replace && (e = e.replace(d, "<$1></$2>")), i === t && (i = h.test(e) && RegExp.$1), i in w || (i = "*"), f = w[i], f.innerHTML = "" + e, o = n.each(a.call(f.childNodes), function() {
            f.removeChild(this)
        })), M(r) && (s = n(o), n.each(r, function(t, e) {
        ...
        for (; e && (e = e.parentNode);)
            if (e === t) return !0;
        return !1
    }, n.type = L, n.isFunction = Z, n.isWindow = D, n.isArray = k, n.isPlainObject = M, n.isEmptyObject = function(t) {
        var e;
        for (e in t) return !1;
        return !0
        ...
        not: function(e) {
            ...
            if (Z(e) && e.call !== t) this.each(function(t) {
                ...
                var r = "string" == typeof e ? this.filter(e) : R(e) && Z(e.item) ? a.call(e) : n(e);
        ...
        css: function(t, i) {
            ...
            var a = "";
            if ("string" == L(t)) i || 0 === i ? a = W(t) + ":" + I(t, i) : this.each(function() {
                this.style.removeProperty(W(t))
            });
            else
                for (e in t) t[e] || 0 === t[e] ? a += W(e) + ":" + I(e, t[e]) + ";" : this.each(function() {
        ...
        removeClass: function(e) {
            return this.each(function(n) {
                if ("className" in this) {
                    ...
                    i = G(this), X(this, e, n, i).split(/\s+/g).forEach(function(t) {
                        i = i.replace(H(t), " ")
                    }), G(this, i.trim())
                }
            })
        ...
        n.fn[e] = function(r) {
            var o, s = this[0];
            return r === t ? D(s) ? s["inner" + i] : $(s) ? s.documentElement["scroll" + i] : (o = this.offset()) && o[e] : this.each(function(t) {
    ...
    }), S.Z.prototype = V.prototype = n.fn, S.uniq = O, S.deserializeValue = K, n.zepto = S, n
}();
    ...
    function(t) {
        ...
        t.fn.delegate = function(t, e, n) {
            ...
            return this.each(function(s, a) {
                i = C(o(e) ? t.Event(e) : e), i._args = n, i.target = a, t.each(h(a, e.type || e), function(t, e) {
    ...
    function(t) {
        ...
        l.href = window.location.href, t.active = 0, t.ajaxJSONP = function(i, r) {
            ...
            if (C.setRequestHeader = m, C.onreadystatechange = function() {
                    if (4 == C.readyState) {
                        C.onreadystatechange = b, clearTimeout(S);
                        var e, n = !1;
